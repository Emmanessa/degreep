      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Foodie</h2>
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Cameroon, Yaounde'</a></li>
                <li><a href="#" class="py-2 d-block">+237 670060018</a></li>
                <li><a href="#" class="py-2 d-block"><emmanuellufung@gmail class="com">emmanuellufung@gmail</emmanuellufung@gmail></a></li>
                <li><a href="#" class="py-2 d-block">official@projectbigbrains.in</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p>
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved<i class="icon-heart"aria-hidden="true"></i> by emmanuellufung</a>
            </p>
          </div>
        </div>
      </div>
